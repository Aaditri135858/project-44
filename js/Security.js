class Security {
    ...
    display(){
        ...
        this.button4.mousePressed(() => {
            if(system.authenticate(accessCode1,this.access4.value())){
                this.button4.hide();
                this.access4.hide();
                score++;
            }
        ...
        this.button5.mousePressed(() => {
            if(system.authenticate(accessCode2,this.access5.value())){
                this.button5.hide();
                this.access5.hide();
                score++;
            }
        ...
        this.button6.mousePressed(() => {
            if(system.authenticate(accessCode3,this.access6.value())){
                this.button6.hide();
                this.access6.hide();
                score++;
            }
        ...
        this.button7.mousePressed(() => {
            if(system.authenticate(accessCode1,this.access7.value())){
                this.button7.hide();
                this.access7.hide();
                score++;
            }
        ...
        this.button8.mousePressed(() => {
            if(system.authenticate(accessCode2,this.access8.value())){
                this.button8.hide();
                this.access8.hide();
                score++;
            }
        ...
        this.button9.mousePressed(() => {
            if(system.authenticate(accessCode3,this.access9.value())){
                this.button9.hide();
                this.access9.hide();
                score++;
            }
